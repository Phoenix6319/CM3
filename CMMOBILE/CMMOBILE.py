...
# Déploiement de la configuration des mises en haut de l'écran (plus simple sur mobile que la sidebar cachée)
...
# Choix des équipes empilées verticalement pour s'adapter à la largeur d'un smartphone
home_team = st.selectbox("Sélectionnez l'Équipe Domicile (A)", liste_pays, index=liste_pays.index("🇫🇷 France"))
...
# UN SEUL ONGLET PAR ÉCRAN MOBILE POUR UNE LECTURE COMPACTE SANS DEFILEMENT INTERMINABLE
